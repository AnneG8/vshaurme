...
Сейчас очень нужна помощь с моделированием системы, почитать о котором можно [здесь]([https://docs.djangoproject.com/en/1.11/intro/tutorial02/#craeting-models](https://docs.djangoproject.com/en/1.11/intro/tutorial02/#craeting-models:~:text=in%20INSTALLED_APPS.-,Creating%20models,-%C2%B6)).
